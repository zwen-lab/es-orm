...
class Builder
{
     ...
     *
     * @var \Zwen\EsOrm\ConnectionInterface
     */
     ...
     *
     * @var \Zwen\EsOrm\Grammars\Grammar
     */
    protected $grammar;
     ...
     *
     * @param  \Zwen\EsOrm\Connection  $connection
     * @param  \Zwen\EsOrm\Grammars\Grammar  $grammar
     * @return void
     */
                                ...
                                EsParser $parse =null)
    {
        ...
        $this->esParse = $parse ?: $connection->getEsParse();
    }
    ...
    {
        return $this->connection->select($this->toDsl($this->toSql(), $this->getBindings()));
    }

    protected function toDsl(string $sql, array $binding) :array
    {
        $sql = str_replace_array('\?', $binding, str_replace('"', '', $sql));

        return $this->esParse->sql2dsl($sql);
    }
